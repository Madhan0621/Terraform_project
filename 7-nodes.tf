...
resource "aws_iam_role_policy_attachment" "nodes_amazon_ec2_container_registry_readonly_policy" {
...
resource "aws_eks_node_group" "private-nodes" {
  ...
  depends_on = [
    ...
    aws_iam_role_policy_attachment.nodes_amazon_ec2_container_registry_readonly_policy
  ]
}